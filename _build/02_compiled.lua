...
function OnCastListener_onCast_CenariusCharacter_fire_onCast_CenariusCharacter1(this19, caster2, __wurst_stackPos23) 
	...
	while true do
		...
		temp75 = SummonTreant_TREANT_DURATION
		...
		clVar.treant = treant
		doAfter(temp75, clVar, "when calling doAfter in CenariusCharacter, line 44")
		i = (i + 1)
	end
...
function OnCastListener_onCast_Hibernate_fire_onCast_Hibernate(this97, caster4, __wurst_stackPos111) 
	...
	temp76 = Hibernate_HEAL_INTERVAL
	...
	healTimer = doPeriodically(temp76, clVar1, "when calling doPeriodically in Hibernate, line 80")
	temp77 = Hibernate_HIBERNATE_DURATION
	...
	clVar2.sfx = sfx
	doAfter(temp77, clVar2, "when calling doAfter in Hibernate, line 85")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function OnCastListener_onCast_SeedBurst_fire_onCast_SeedBurst(this145, caster5, __wurst_stackPos166) 
	...
	while true do
		...
		doAfter(temp79, clVar3, "when calling doAfter in SeedBurst, line 64")
...
function OnCastListener_onCast_SpiritWisps_fire_onCast_SpiritWisps(this156, caster6, __wurst_stackPos179) 
	...
	temp80 = SpiritWisps_UPDATE_INTERVAL
	...
	moveTimer = doPeriodically(temp80, clVar4, "when calling doPeriodically in SpiritWisps, line 78")
	temp81 = SpiritWisps_HEAL_INTERVAL
	...
	healTimer1 = doPeriodically(temp81, clVar5, "when calling doPeriodically in SpiritWisps, line 118")
	temp82 = SpiritWisps_WISP_DURATION
	...
	doAfter(temp82, clVar6, "when calling doAfter in SpiritWisps, line 126")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_Bloom(__wurst_stackPos291) 
	...
	EventListener_onCast(temp50, clVar7, "when calling onCast in Bloom, line 73")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function spawnCloud(owner, pos1, __wurst_stackPos18) 
	...
	clVar8.owner = owner
	healTimer2 = doPeriodically(temp51, clVar8, "when calling doPeriodically in Bloom, line 58")
	temp52 = Bloom_CLOUD_DURATION
	...
	clVar9.cloud = cloud
	clVar9.sfx = sfx1
	doAfter(temp52, clVar9, "when calling doAfter in Bloom, line 66")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_CenariusCharacter(__wurst_stackPos295) 
	...
	wurst_stack_depth = (wurst_stack_depth + 1)
	temp53 = Invigorate_INVIGORATE_ID
	...
	EventListener_onCast(temp53, clVar10, "when calling onCast in CenariusCharacter, line 29")
	temp54 = SummonTreant_SUMMON_TREANT_ID
	...
	EventListener_onCast(temp54, clVar11, "when calling onCast in CenariusCharacter, line 33")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function unregisterEventsForUnit(u16, __wurst_stackPos353) 
	local index2 = nil
	local listener5 = nil
	local t1 = nil
...
function EventListener_addSpellInternal(u17, abilId1, listener8, __wurst_stackPos364) 
	local index3 = nil
	local entry1 = nil
...
function init_DamageEvent(__wurst_stackPos298) 
	...
	DamageEvent_maxPriority = 0
	DamageEvent_maxUnreducedPriority = 0
	temp57 = EVENT_PLAYER_UNIT_DAMAGING
	...
	EventListener_add(temp57, clVar13, "when calling add in DamageEvent, line 476")
	temp58 = EVENT_PLAYER_UNIT_DAMAGED
	...
	EventListener_add(temp58, clVar14, "when calling add in DamageEvent, line 477")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
		...
		if not(ErrorHandling_suppressErrorMessages) then
			...
			if hashtable_hasInt(ErrorHandling_HT, ErrorHandling_PRIMARY_ERROR_KEY, hash, "when calling hasInt in ErrorHandling, line 54") then
				if ((hashtable_loadInt(ErrorHandling_HT, ErrorHandling_PRIMARY_ERROR_KEY, hash, "when calling loadInt in ErrorHandling, line 56") + ErrorHandling_MUTE_ERROR_DURATION) < GameTimer_currentTime) then
					...
					Log_error(stringConcat(temp59, stacktraceStr), "when calling error in ErrorHandling, line 58")
				...
				temp60 = stringConcat("Message: ", msg)
				...
				Log_error(stringConcat(temp60, stacktraceStr1), "when calling error in ErrorHandling, line 70")
			end
		end
		ErrorHandling_lastError = msg
...
function init_HeroTrainer(__wurst_stackPos304) 
	...
	temp61 = EVENT_PLAYER_UNIT_TRAIN_FINISH
	...
	EventListener_add(temp61, clVar16, "when calling add in HeroTrainer, line 9")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_Hibernate(__wurst_stackPos305) 
	...
	EventListener_onCast(temp62, clVar17, "when calling onCast in Hibernate, line 65")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function pushUnit1(u25, __wurst_stackPos450) 
...
function finishPreload(__wurst_stackPos161) 
	...
	temp64 = Preloader_dumg
	clVar22 = ForGroupCallback_forEachFrom_Preloader:create34()
	group_forEachFrom(temp64, clVar22, "when calling forEachFrom in Preloader, line 48")
...
function init_Recycle(__wurst_stackPos308) 
	...
	temp65 = EVENT_PLAYER_UNIT_DEATH
	...
	EventListener_add(temp65, clVar23, "when calling add in Recycle, line 41")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function registerPlayerUnitEvent(p2, filter2, condition, action, __wurst_stackPos34) 
	...
	if (RegisterEvents_t[hid] == nil) then
		...
		while true do
			...
			temp66 = RegisterEvents_t[hid]
			temp67 = Player_players[k]
			temp68 = p2
			...
			trigger_registerPlayerUnitEvent(temp66, temp67, temp68, cond_result4, "when calling registerPlayerUnitEvent in RegisterEvents, line 21")
			k = (k - 1)
		end
	end
...
function init_SeedBurst(__wurst_stackPos294) 
	...
	temp69 = SeedBurst_SEED_BURST_ID
	...
	EventListener_onCast(temp69, clVar24, "when calling onCast in SeedBurst, line 52")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_SpiritWisps(__wurst_stackPos302) 
	...
	temp70 = SpiritWisps_SPIRIT_WISPS_ID
	...
	EventListener_onCast(temp70, clVar26, "when calling onCast in SpiritWisps, line 61")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function trigger_registerUnitEvent(this226, whichUnit8, whichEvent1, __wurst_stackPos391) 
...
function booleanToIndex(u22, __wurst_stackPos423) 
...
function init_UrsocCharge(__wurst_stackPos312) 
	...
	temp71 = UrsocCharge_URSOC_CHARGE_ID
	...
	EventListener_onCast(temp71, clVar27, "when calling onCast in UrsocCharge, line 93")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
