...
function OnCastListener_onCast_CenariusCharacter_fire_onCast_CenariusCharacter1(this19, caster2, __wurst_stackPos23) 
	...
	while true do
		...
		temp27 = SummonTreant_TREANT_DURATION
		...
		clVar.treant = treant
		doAfter(temp27, clVar, "when calling doAfter in CenariusCharacter, line 44")
		i = (i + 1)
	end
...
function OnCastListener_onCast_Hibernate_fire_onCast_Hibernate(this97, caster4, __wurst_stackPos111) 
	...
	temp28 = Hibernate_HEAL_INTERVAL
	...
	healTimer = doPeriodically(temp28, clVar1, "when calling doPeriodically in Hibernate, line 80")
	temp29 = Hibernate_HIBERNATE_DURATION
	...
	clVar2.sfx = sfx
	doAfter(temp29, clVar2, "when calling doAfter in Hibernate, line 85")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function OnCastListener_onCast_SeedBurst_fire_onCast_SeedBurst(this145, caster5, __wurst_stackPos166) 
	...
	while true do
		...
		doAfter(temp31, clVar3, "when calling doAfter in SeedBurst, line 64")
...
function OnCastListener_onCast_SpiritWisps_fire_onCast_SpiritWisps(this156, caster6, __wurst_stackPos179) 
	...
	while true do
		...
		unit_setVertexColor(wisp, 100, 250, 200, 200, "when calling setVertexColor in SpiritWisps, line 72")
	...
	temp32 = SpiritWisps_UPDATE_INTERVAL
	...
	moveTimer = doPeriodically(temp32, clVar4, "when calling doPeriodically in SpiritWisps, line 78")
	temp33 = SpiritWisps_HEAL_INTERVAL
	...
	healTimer1 = doPeriodically(temp33, clVar5, "when calling doPeriodically in SpiritWisps, line 118")
	temp34 = SpiritWisps_WISP_DURATION
	...
	doAfter(temp34, clVar6, "when calling doAfter in SpiritWisps, line 126")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function OnCastListener_onCast_UrsocCharge_fire_onCast_UrsocCharge(this192, caster7, __wurst_stackPos217) 
	...
	targetPos1 = tupleCopy(unit_getPos(target6, "when calling getPos in UrsocCharge, line 64"))
	unit_setXY(caster7, targetPos1, "when calling setXY in UrsocCharge, line 67")
	flashEffect1(UrsocCharge_CHARGE_SFX, targetPos1, "when calling flashEffect in UrsocCharge, line 69")
	flashEffect1(UrsocCharge_IMPACT_SFX, targetPos1, "when calling flashEffect in UrsocCharge, line 70")
...
function init_Bloom(__wurst_stackPos291) 
	...
	EventListener_onCast(temp21, clVar7, "when calling onCast in Bloom, line 73")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function spawnCloud(owner, pos1, __wurst_stackPos18) 
	...
	clVar8.owner = owner
	healTimer2 = doPeriodically(temp35, clVar8, "when calling doPeriodically in Bloom, line 58")
	temp41 = Bloom_CLOUD_DURATION
	...
	clVar9.cloud = cloud
	clVar9.sfx = sfx1
	doAfter(temp41, clVar9, "when calling doAfter in Bloom, line 66")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_CenariusCharacter(__wurst_stackPos295) 
	...
	wurst_stack_depth = (wurst_stack_depth + 1)
	temp51 = Invigorate_INVIGORATE_ID
	...
	EventListener_onCast(temp51, clVar10, "when calling onCast in CenariusCharacter, line 29")
	temp61 = SummonTreant_SUMMON_TREANT_ID
	...
	EventListener_onCast(temp61, clVar11, "when calling onCast in CenariusCharacter, line 33")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_DamageEvent(__wurst_stackPos297) 
	...
	DamageEvent_maxPriority = 0
	DamageEvent_maxUnreducedPriority = 0
	temp9 = EVENT_PLAYER_UNIT_DAMAGING
	...
	EventListener_add(temp9, clVar13, "when calling add in DamageEvent, line 476")
	temp10 = EVENT_PLAYER_UNIT_DAMAGED
	...
	EventListener_add(temp10, clVar14, "when calling add in DamageEvent, line 477")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
		...
		if not(ErrorHandling_suppressErrorMessages) then
			...
			if hashtable_hasInt(ErrorHandling_HT, ErrorHandling_PRIMARY_ERROR_KEY, hash, "when calling hasInt in ErrorHandling, line 54") then
				if ((hashtable_loadInt(ErrorHandling_HT, ErrorHandling_PRIMARY_ERROR_KEY, hash, "when calling loadInt in ErrorHandling, line 56") + ErrorHandling_MUTE_ERROR_DURATION) < GameTimer_currentTime) then
					...
					Log_error(stringConcat(temp111, stacktraceStr), "when calling error in ErrorHandling, line 58")
				...
				temp121 = stringConcat("Message: ", msg)
				...
				Log_error(stringConcat(temp121, stacktraceStr1), "when calling error in ErrorHandling, line 70")
			end
		end
		ErrorHandling_lastError = msg
...
function init_HeroTrainer(__wurst_stackPos303) 
	...
	temp13 = EVENT_PLAYER_UNIT_TRAIN_FINISH
	...
	EventListener_add(temp13, clVar16, "when calling add in HeroTrainer, line 9")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_Hibernate(__wurst_stackPos304) 
	...
	EventListener_onCast(temp14, clVar17, "when calling onCast in Hibernate, line 65")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function finishPreload(__wurst_stackPos161) 
	...
	temp161 = Preloader_dumg
	clVar22 = ForGroupCallback_forEachFrom_Preloader:create34()
	group_forEachFrom(temp161, clVar22, "when calling forEachFrom in Preloader, line 48")
...
function Loglevel_getTag(this262, __wurst_stackPos464) 
	...
	elseif (temp17 == 1) then
		wurst_stack_depth = (wurst_stack_depth - 1)
		return "|cff2685DCdebug|r"
	elseif (temp17 == 2) then
		wurst_stack_depth = (wurst_stack_depth - 1)
		return "|cffFFCC00info|r"
	elseif (temp17 == 3) then
		wurst_stack_depth = (wurst_stack_depth - 1)
...
function init_Recycle(__wurst_stackPos307) 
	...
	temp171 = EVENT_PLAYER_UNIT_DEATH
	...
	EventListener_add(temp171, clVar23, "when calling add in Recycle, line 41")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function registerPlayerUnitEvent(p2, filter2, condition, action, __wurst_stackPos34) 
	...
	if (RegisterEvents_t[hid] == nil) then
		...
		while true do
			...
			temp18 = RegisterEvents_t[hid]
			temp19 = Player_players[k]
			temp20 = p2
			...
			trigger_registerPlayerUnitEvent(temp18, temp19, temp20, cond_result4, "when calling registerPlayerUnitEvent in RegisterEvents, line 21")
			k = (k - 1)
		end
	end
...
function init_SeedBurst(__wurst_stackPos294) 
	...
	temp211 = SeedBurst_SEED_BURST_ID
	...
	EventListener_onCast(temp211, clVar24, "when calling onCast in SeedBurst, line 52")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_SpiritWisps(__wurst_stackPos301) 
	...
	temp22 = SpiritWisps_SPIRIT_WISPS_ID
	...
	EventListener_onCast(temp22, clVar26, "when calling onCast in SpiritWisps, line 61")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
...
function init_UrsocCharge(__wurst_stackPos311) 
	...
	temp231 = UrsocCharge_URSOC_CHARGE_ID
	...
	EventListener_onCast(temp231, clVar27, "when calling onCast in UrsocCharge, line 62")
	wurst_stack_depth = (wurst_stack_depth - 1)
end
